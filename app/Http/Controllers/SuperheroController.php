...
class SuperheroController extends Controller
{
    ...
    public function all(Request $request)
    {
        ...
        if ($validator->fails())
            return response()->json(['status' => 'error', 'response' => $validator->messages()->all()]);
    ...
    protected function validator(array $data)
    {
        return Validator::make($data, [
            ...
            'sortBy' => ValidationRule::in(['name', 'fullName', 'strength', 'speed', 'durability', 'power', 'combat', 'race', 'height/0', 'height/1', 'weight/0', 'weight/1', 'eyeColor', 'hairColor', 'publisher',]),
